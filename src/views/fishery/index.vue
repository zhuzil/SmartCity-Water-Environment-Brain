...
export default {
  ...
  methods: {
      ...
      AMapLoader.load({
        ...
        .then((AMap) => {
          this.map = new AMap.Map("container", {
            ...
            zoom: 10, //初始化地图级别
            center: [114.284908, 30.545242], //初始化地图中心点位置
          });
          this.drawBounds();
    ...
    getPoints(){
      var title = ["湖北华电武昌热电有限公司","华电湖北发电有限公司","农业生产资料公司","武汉恒源玻璃有限公司","华新混凝土(武穴)有限公司","长山口华新预处理厂","富锐灰砂砖厂","鲁湖养殖场","武汉市新洲区四季春养殖场","武汉市水务防汛信息中心"]
      var type = ["排污企业","重点工业企业","重点工业企业","重点工业企业","重点工业企业","污水处理","排污企业","养殖场","养殖场","监测点"]
      var waterQuality = ["I","II","III","IV","V"]
      var style = ['#00CCFF','#00CCFF','#00FF00','#FFFF00','#FF9B00']
      var QualityIndex = [0,3,4,3,2,3,4,5,3,1]
      var around = [[114.316725,30.577965],[114.322709,30.583148],[113.690489,31.2643],[114.297716,30.514498],[115.49187,29.874664],[115.925991,30.055351],[114.597667,30.524049],[114.163662,30.250952],[114.533792,30.724484],[114.313707,30.607421]];
      var p = [3.4,45]
      var ph=[8.04,]
      for(var i=0;i<around.length;i++){
        ...
        var curwaterQuality = waterQuality[QualityIndex[i]]
        mker.content=[];
        mker.content.push(
          ""+"<div>"+"站点名称："+title[i]+
          "<div>水质："+"<span  style=\"background-color:"+style[QualityIndex[i]]+"\">"+"   "+`${curwaterQuality}`+"   "+"</span>"+"</div>"+
          "</div>"+"<div>"+"经度"+around[i][0]+"</div>"+
          "<div>"+"纬度"+around[i][1]+"</div>"+
          "<div>"+"磷含量："+"<span style='color: #66A0FF'>"+3.4+"</span>"+"</div>"+
